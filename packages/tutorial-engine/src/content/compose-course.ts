  ...
  steps: [
    {
      ...
      explanation:
        'スケールスナップは、オンにした後に新しく追加した音や移動した音を、Cメジャーの音に合わせます。すでに置かれている音は変わりません。初めてのメロディは、スケール内の音から始めるとまとまりやすくなります。',
      goal: {
        kind: 'event',
  ...
  steps: [
    {
      ...
      hints: [
        '「アレンジ」タブを開き、上部の「＋ セクションを追加」ボタンを押しましょう。',
        '追加されたセクションを選び、「セクション種類」で「サビ」を選んでください。',
      ],
    },
    {
      id: 'compose-5-s2',
