...
6. **完了済み基盤**: stereo Bus、main output、pre/post-fader send、循環拒否、live/offline共通routing graphを実装する。次は単一入力録音またはautomation lane UIを独立incrementとして進める。
...
### Batch 6: 録音 / comping / bus-send（6b実装済み）
