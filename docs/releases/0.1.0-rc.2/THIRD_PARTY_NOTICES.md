...
Generated at: 2026-07-06T21:43:11.797Z

This inventory is generated from runtime npm dependencies in `apps/studio/package.json` and crates in `apps/studio/src-tauri/Cargo.lock`.
...
|---|---|---|---|
| @tauri-apps/api |2.11.0 |Apache-2.0 OR MIT |git+https://github.com/tauri-apps/tauri.git |
...
| react |19.2.7 |MIT |https://github.com/facebook/react.git |
| react-dom |19.2.7 |MIT |https://github.com/facebook/react.git |
| scheduler |0.27.0 |MIT |https://github.com/facebook/react.git |
| zustand |5.0.14 |MIT |git+https://github.com/pmndrs/zustand.git |
